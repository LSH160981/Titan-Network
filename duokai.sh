...
install_node() {
    ...
    docker run -d  --name Nodepay --restart unless-stopped  -e NP_COOKIE="eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxMzcxNDYzNzMwMDM4ODQ5NTM2IiwiaWF0IjoxNzQ3MDUyODU0LCJleHAiOjE3NDgyNjI0NTR9.27UigsfzjT2snq3JHh0ivheVlV5BKlaUPt1AdIi_AftSZ9Pu2ZMf4EC-oy8jARPtzu2cmz52XWJUrVyQ_Q_Icw"  kellphy/nodepay
    # 每天0点重启所有的docker容器
